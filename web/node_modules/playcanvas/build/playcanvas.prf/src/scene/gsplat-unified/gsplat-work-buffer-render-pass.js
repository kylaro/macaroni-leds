...
class GSplatWorkBufferRenderPass extends RenderPass {
		...
		constructor(device, workBuffer, colorOnly = false){
				super(device), this.splats = [], this.colorsByLod = undefined, this.cameraNode = null, this._modelScaleData = new Float32Array(3), this._modelRotationData = new Float32Array(4), this._textureSize = new Int32Array(2), this._partialData = [];
