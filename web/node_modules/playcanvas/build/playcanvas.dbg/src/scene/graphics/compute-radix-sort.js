 ...
 */ class ComputeRadixSort {
     ...
     */ _createPasses(numBits, indirect, hasInitialValues) {
        ...
        for(let pass = 0; pass < numPasses; pass++){
            ...
            const blockSumShader = this._createShader(`RadixSort4bit-BlockSum${suffix}-${bitOffset}`, radixSort4bitSource, bitOffset, false, this._blockSumBindGroupFormat, indirect);
            const reorderShader = this._createShader(`RadixSort4bit-Reorder${suffix}-${bitOffset}`, radixSortReorderSource, bitOffset, isFirstPass, this._reorderBindGroupFormat, indirect);
