 ...
 */ class GSplatManager {
    ...
    updateWorldState() {
        ...
        if (worldChanged) {
            ...
            const newState = new GSplatWorldState(this.device, this.lastWorldStateVersion, splats, this._allocator, this._allocationMap);
     ...
     */ cleanupOldWorldStates(newVersion) {
        const activeState = /** @type {unknown} */ this.worldStates.get(newVersion);
     ...
     */ dispatchGpuSort(elementCount, roundedNumBits, minDist, maxDist, compactedSplatIds) {
        ...
        const keysBuffer = keyGenerator.generateIndirect(this.workBuffer, this.cameraNode, this.scene.gsplat.radialSorting, elementCount, roundedNumBits, minDist, maxDist, /** @type {StorageBuffer} */ compactedSplatIds, /** @type {StorageBuffer} */ ic.sortElementCountBuffer, this.indirectDispatchSlot);
        ...
        return gpuSorter.sortIndirect(keysBuffer, elementCount, roundedNumBits, this.indirectDispatchSlot, /** @type {StorageBuffer} */ ic.sortElementCountBuffer, /** @type {StorageBuffer} */ compactedSplatIds);
    }
    /**
     ...
     */ _runCpuCompaction() {
        ...
        this.compaction.dispatchCompact(pcNodeIndexTexture, nodeVisibilityTexture, elementCount, this.workBuffer.textureSize, orderBuffer);
        ...
        this.renderer.setIndirectDraw(this.indirectDrawSlot, /** @type {StorageBuffer} */ this.compaction.compactedSplatIds, /** @type {StorageBuffer} */ this.compaction.numSplatsBuffer);
        this.renderer.updateIndirect(sortedState.textureSize);
    }
    /**
     ...
     */ this._centersVersions = new Map();
        ...
        /** @type {number} */ this.lastLodCameraFov = -1;
        ...
        /** @type {Vec3} */ this.lastCullingCameraFwd = new Vec3(Infinity, Infinity, Infinity);
        /** @type {Mat4} */ this.lastCullingProjMat = new Mat4();
