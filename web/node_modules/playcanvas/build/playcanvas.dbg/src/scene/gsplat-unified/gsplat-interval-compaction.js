...
import { BindUniformBufferFormat, BindStorageBufferFormat, BindTextureFormat, BindGroupFormat } from '../../platform/graphics/bind-group-format.js';
 ...
 */ class GSplatIntervalCompaction {
     ...
     */ _ensureCullPass(cullingEnabled) {
        ...
        /** @type {Map<string, string>} */ const cdefines = new Map([
            [
                '{WORKGROUP_SIZE}',
     ...
     */ writeIndirectArgs(drawSlot, dispatchSlot, numIntervals) {
        ...
        this.device.computeDispatch([
            compute
        ], 'GSplatIntervalWriteIndirectArgs');
    }
    /**
     * @param {GraphicsDevice} device - The graphics device (must support compute).
     */ constructor(device){
        /** @type {StorageBuffer|null} */ this.compactedSplatIds = null;
        /** @type {StorageBuffer|null} */ this.intervalsBuffer = null;
        /** @type {StorageBuffer|null} */ this.countBuffer = null;
        /** @type {PrefixSumKernel|null} */ this.prefixSumKernel = null;
        /** @type {StorageBuffer|null} */ this.numSplatsBuffer = null;
        /** @type {StorageBuffer|null} */ this.sortElementCountBuffer = null;
        /** @type {number} */ this.allocatedCompactedCount = 0;
        /** @type {number} */ this.allocatedIntervalCount = 0;
        /** @type {number} */ this.allocatedCountBufferSize = 0;
        /**
     ...
     */ this._cullingEnabled = false;
        /** @type {Compute|null} */ this._cullCompute = null;
        /** @type {Compute|null} */ this._scatterCompute = null;
        /** @type {Compute|null} */ this._writeIndirectArgsCompute = null;
        /** @type {BindGroupFormat|null} */ this._cullBindGroupFormat = null;
        /** @type {BindGroupFormat|null} */ this._scatterBindGroupFormat = null;
        /** @type {BindGroupFormat|null} */ this._writeArgsBindGroupFormat = null;
        /** @type {UniformBufferFormat|null} */ this._cullUniformBufferFormat = null;
        /** @type {UniformBufferFormat|null} */ this._scatterUniformBufferFormat = null;
        /** @type {UniformBufferFormat|null} */ this._writeArgsUniformBufferFormat = null;
