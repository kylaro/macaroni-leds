...
export class GSplatInfo {
     ...
     */
    constructor(device: GraphicsDevice, resource: GSplatResourceBase, placement: GSplatPlacement, consumeRenderDirty?: Function | null, octreeNodes?: GSplatOctreeNode[] | null, nodeInfos?: Array<{
        allocId: number;
    }> | null);
    /** @type {GraphicsDevice} */
